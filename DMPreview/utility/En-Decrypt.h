...
#define APC_EN_DECRYPT_INPUT_FILE_NULL		-100
#define APC_EN_DECRYPT_OPEN_FILE_FAIL		-101
#define APC_EN_DECRYPT_GET_SIZE_FAIL		-102
#define APC_EN_DECRYPT_MORE_4G_SIZE_FAIL	-103
#define APC_EN_DECRYPT_PARSE_ORDER_FAIL	-104
#define APC_EN_DECRYPT_WRITE_FAIL			-105
#define APC_EN_DECRYPT_FOUND_FAIL			-106
#define APC_EN_DECRYPT_INVALID_ENCRYPT	-107
#define APC_ENCRYPT_FILE_TYPE_FAIL			-108
#define APC_DECRYPT_FILE_TYPE_FAIL			-109
#define APC_EN_DECRYPT_FILE_TYPE_FAIL		-110
#define APC_EN_DECRYPT_4BYTE_WRITE_FAIL		-111
