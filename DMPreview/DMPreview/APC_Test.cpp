...
LONG CAPC_TestApp::TopLevelFilter( struct _EXCEPTION_POINTERS *pExceptionInfo )
{
	...
	if ( pDump )
	{
        ...
        wcscpy( wcsrchr( szPath, '\\' ), L"\\APC_App.dmp" );
...
BEGIN_MESSAGE_MAP(CAPC_TestApp, CWinAppEx)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()

CAPC_TestApp::CAPC_TestApp()
{
}

BOOL CAPC_TestApp::InitInstance()
{
