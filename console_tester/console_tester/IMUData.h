...
public:
	...
	/// **************************************** ///
	// Rem 0910 Default MaxG for 8062 is 8G
	void setMaxG(float max_g_in) { MAX_G = max_g_in; }
	// Rem
	...
	int _module_id;				// RAW:[6] 1byte	// DMP:[6] 1byte
	...
	unsigned char _updateReason;    // RAW:[22], used by IVY2 only
};
